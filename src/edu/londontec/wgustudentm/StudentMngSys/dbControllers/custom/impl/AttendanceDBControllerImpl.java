...
public class AttendanceDBControllerImpl implements AttendanceDBController{
    ...
    public ArrayList<AttendanceDTO> getTableDetails() throws Exception {
        ...
        String sql="SELECT student.name,nic,tel1,classes.name,batch.hall FROM student,reg_detail,classes,batch,attendance WHERE student.sid=reg_detail.sid && reg_detail.bid=batch.bid && batch.cid=classes.cid && reg_detail.rid=attendance.rid";
